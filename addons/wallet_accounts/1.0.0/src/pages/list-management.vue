<template>
  <f7-page name="wallet_accounts__list-management" id="wallet_accounts__list-management" class="wallet_accounts__page">
    <f7-navbar>
      <tommy-nav-back></tommy-nav-back>
      <f7-nav-title>{{$t('wallet_accounts.list-management.title', 'List Management')}}</f7-nav-title>
      <f7-nav-right>
