...
var IndexController = {
  init: function init(page) {
    ...
    $$(page.container).click(function (e) {
      ...
      if (timeDiff < 300) window.tommy.app.f7view.router.back();
...
window.tommy.app.f7.onPageInit('vitals_demo__index', _index2.default.init);
window.tommy.app.f7.onPageBack('vitals_demo__index', _index2.default.uninit);
