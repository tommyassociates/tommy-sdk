...
export default {
  ...
  init(self) {
    ...
    function handleInputChange(e) {
      ...
      const index = parseInt(app.$(e.target).attr('data-color-index'), 10);
  ...
  update(self) {
    ...
    const hslCurrent = colorUtils.colorHsbToHsl(hsb[0], hsb[1], 1);
    const hslLeft = colorUtils.colorHsbToHsl(hsb[0], 0, 1);
    const hslRight = colorUtils.colorHsbToHsl(hsb[0], 1, 1);
