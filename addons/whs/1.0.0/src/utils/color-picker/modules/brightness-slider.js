...
export default {
  ...
  update(self) {
    ...
    const hslCurrent = colorUtils.colorHsbToHsl(hsb[0], hsb[1], hsb[2]);
    const hslLeft = colorUtils.colorHsbToHsl(hsb[0], hsb[1], 0);
    const hslRight = colorUtils.colorHsbToHsl(hsb[0], hsb[1], 1);
