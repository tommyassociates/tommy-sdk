<template>
  <f7-page>
    <f7-navbar>
      ...
      <f7-nav-title>{{$t('whs.settings_edit.title_activities')}}</f7-nav-title>
    ...
    <f7-list class="no-margin no-hairlines whs-settings-list">
      ...
      />    
        ...
        />
        <f7-list-item
          :title="$t('whs.settings.view_settings_main_menu')"
          link
        />
        <f7-list-item
          :title="$t('whs.settings.view_settings_summary')"
          link
        />
        <f7-list-item
        ...
        />
        <f7-list-item
          :title="$t('whs.settings.view_settings_tags')"
          link
        />
        <f7-list-item
          :title="$t('whs.settings.view_settings_activities')"
          link
        />
      </ul>
    </f7-list>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        edited: false,
        settings: Object.assign({}, API.main_page.$data.settings.activity),
      };
    },
    created() {
    ...
    methods: {
      ...
      updateSettings(){
        self = this;
        self.edited = false;
        API.main_page.$data.settings.activity = self.settings;
        API.saveSettings('activity',self.settings).then(()=>{
