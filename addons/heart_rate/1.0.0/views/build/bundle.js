...
var IndexController = {
  init: function init(page) {
    ...
    window.tommy.tplManager.renderInline('heart_rate__sliderTemplate', null, page.container);
...
window.tommy.app.f7.onPageInit('heart_rate__index', _index2.default.init);
window.tommy.app.f7.onPageBack('heart_rate__index', _index2.default.uninit);
