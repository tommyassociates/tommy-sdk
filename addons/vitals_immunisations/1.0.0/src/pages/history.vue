<template>
  <f7-page :class="`vitals-element-history-page vitals-${vitalsElement}-history-page`">
    <f7-navbar>
      <tommy-nav-back></tommy-nav-back>
      <f7-nav-title>{{t('title', 'History')}}</f7-nav-title>
    </f7-navbar>
    ...
    <div :class="`vitals-element-index-no-data vitals-${vitalsElement}-index-no-data`" v-if="data && !data.length">
      ...
      <span>{{t('not_available', 'When you have previous records, they will show here.')}}</span>
    </div>
