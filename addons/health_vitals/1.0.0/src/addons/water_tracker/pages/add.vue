  ...
  <f7-page id="vitals_element__add" :class="`vitals-element-manual-add-page vitals-${vitalsElement}-manual-add-page`">
    ...
    <f7-list no-chevron no-hairlines no-hairlines-between>
      <f7-list-item
        ...
        @click="addValue(150)"
      >
        <img :src="`${$addonAssetsUrl}${vitalsElement}/card-icon-cup.svg`" slot="media">
      </f7-list-item>
      <f7-list-item
        link
        ...
        @click="addValue(220)"
      >
        <img :src="`${$addonAssetsUrl}${vitalsElement}/card-icon-glass.svg`" slot="media">
      </f7-list-item>
      <f7-list-item
        link
        ...
        @click="addValue(350)"
      >
        <img :src="`${$addonAssetsUrl}${vitalsElement}/card-icon-bottle.svg`" slot="media">
      </f7-list-item>
      <f7-list-item
        link
