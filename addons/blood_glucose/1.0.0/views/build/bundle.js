...
var IndexController = {
  init: function init(page) {
    ...
    window.tommy.tplManager.renderInline('blood_glucose__sliderTemplate', null, page.container);
...
window.tommy.app.f7.onPageInit('blood_glucose__index', _index2.default.init);
window.tommy.app.f7.onPageBack('blood_glucose__index', _index2.default.uninit);
