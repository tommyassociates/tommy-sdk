<template>
  <f7-page name="invoicing__list-management" id="invoicing__list-management" class="invoicing__page">
    <f7-navbar>
      <tommy-nav-back></tommy-nav-back>
      <f7-nav-title>{{$t('invoicing.list_management.title', 'List Management')}}</f7-nav-title>
      <f7-nav-right>
    ...
    <f7-list class="list-custom margin-bottom" inset>
      <f7-list-item
        ...
        :title="$t('invoicing.list_management.create_list', 'Create New List')"
      ></f7-list-item>
    </f7-list>
  </f7-page>
</template>
