...
var IndexController = {
  init: function init(page) {
    ...
    window.tommy.tplManager.renderInline('pedometer__sliderTemplate', null, page.container);
...
window.tommy.app.f7.onPageInit('pedometer__index', _index2.default.init);
window.tommy.app.f7.onPageBack('pedometer__index', _index2.default.uninit);
