...
var IndexController = {
  init: function init(page) {
    ...
    window.tommy.tplManager.renderInline('water_tracker__sliderTemplate', null, page.container);
...
window.tommy.app.f7.onPageInit('water_tracker__index', _index2.default.init);
window.tommy.app.f7.onPageBack('water_tracker__index', _index2.default.uninit);
