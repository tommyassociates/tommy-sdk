...
var IndexController = {
  init: function init(page) {
    ...
    window.tommy.tplManager.renderInline('happy_life__sliderTemplate', null, page.container);
...
window.tommy.app.f7.onPageInit('happy_life__index', _index2.default.init);
window.tommy.app.f7.onPageBack('happy_life__index', _index2.default.uninit);
