...
Framework7.prototype.plugins.panels3d = function (app, params) {
    ...
    function setPanelTransform(viewsContainer, panel, perc) {
        ...
        if (panel.hasClass('panel-left')) {
            ...
            views.css({
                '-webkit-transform-origin': '100% center', /*originally 100%*/
                'transform-origin': '100% center',/*originally 100%*/
            });
            panel.transform('translate3d(' + (-leftPanelWidth * (1 - perc)) + 'px,20px,0)');
        }
